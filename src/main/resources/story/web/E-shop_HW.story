...
When I click on element located by `xpath(//a[@href='/register' and contains(@class, 'ico-register')])`
When I enter `Vasya` in field located by `xpath(//input[@id='FirstName'])`
When I enter `Pupkin` in field located by `xpath(//input[@id='LastName'])`
When I enter `VPupkin@test1.com` in field located by `xpath(//input[@id='Email'])`
When I enter `123456John` in field located by `xpath(//input[@id='Password'])`
When I enter `123456John` in field located by `xpath(//input[@id='ConfirmPassword'])`
When I click on a button with the name 'Register'
